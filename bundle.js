...
class Api {
  ...
  createComment(movieId, comment) {
    return this._load({
      ...
      .then((response) => response.json())
      .then((newData) => ({
        movie: _models_movie__WEBPACK_IMPORTED_MODULE_0__["default"].parseMovie(newData.movie),
        comments: _models_comments__WEBPACK_IMPORTED_MODULE_1__["default"].parseComments(newData.comments),
      }));
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FilmsExtraContainer; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");
...
class FilmsExtraContainer extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(title) {
    super();
    this._title = title;
  }
...
const createCommentsTemplate = (comments) => {
  return Array.from(comments)
    ...
    .map((comment) => (`<li class="film-details__comment">
                            ...
                            <div>
                                <p class="film-details__comment-text">${he__WEBPACK_IMPORTED_MODULE_2___default.a.encode(comment.comment)}</p>
                                <p class="film-details__comment-info">
                                    <span class="film-details__comment-author">${comment.author}</span>
                                    <span class="film-details__comment-day">${Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["formatCommentDate"])(comment.date)}</span>
    ...
    `<section class="film-details">
      ...
      : ``
                ...
                <tr class="film-details__row">
                  ...
                  <td class="film-details__cell">${Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["formatDate"])(releaseDate)}</td>
                </tr>
                <tr class="film-details__row">
                  <td class="film-details__term">Runtime</td>
                  <td class="film-details__cell">${Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["formatTime"])(runtime)}</td>
                </tr>
                <tr class="film-details__row">
                ...
                ${genre.size > 0 ?
      `<tr class="film-details__row">
        <td class="film-details__term">${pluralize__WEBPACK_IMPORTED_MODULE_3___default()(`Genre`, genre.size)}</td>
          ...
          <section class="film-details__comments-wrap">
            ...
            <div class="film-details__new-comment">
              ...
              <div class="film-details__emoji-list">
                ${createEmotionListTemplate(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["commentEmotions"])}
              </div>
            </div>
          </section>
        </div>
  ...
  (
    `<article class="film-card">
        ...
        <p class="film-card__info">
          <span class="film-card__year">${Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["formatYear"])(releaseDate)}</span>
          <span class="film-card__duration">${Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(runtime)}</span>
        ...
        <a class="film-card__comments">
            ${pluralize__WEBPACK_IMPORTED_MODULE_2___default()(`comment`, comments.length, true)}
        </a>
...
class Film extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(film) {
    super();
    this._film = film;
  }
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MenuFilters; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");
...
const createFiltersTemplate = (data, activeItem) => {
  return (
    `<nav class="main-navigation">
      <a href="#all" data-menu-type="${MenuType.FILTER}" class="main-navigation__item ${data[_models_movies__WEBPACK_IMPORTED_MODULE_1__["FilterName"].ALL].isActive && activeItem === MenuType.FILTER ? `main-navigation__item--active` : ``}">All movies</a>
      <a href="#watchlist" data-menu-type="${MenuType.FILTER}" class="main-navigation__item ${data[_models_movies__WEBPACK_IMPORTED_MODULE_1__["FilterName"].WATCHLIST].isActive && activeItem === MenuType.FILTER ? `main-navigation__item--active` : ``}">${data.watchlist.name[0].toUpperCase()}${data.watchlist.name.slice(1)} <span class="main-navigation__item-count">${data.watchlist.count}</span></a>
      <a href="#history" data-menu-type="${MenuType.FILTER}" class="main-navigation__item ${data[_models_movies__WEBPACK_IMPORTED_MODULE_1__["FilterName"].HISTORY].isActive && activeItem === MenuType.FILTER ? `main-navigation__item--active` : ``}">${data.history.name[0].toUpperCase()}${data.history.name.slice(1)} <span class="main-navigation__item-count">${data.history.count}</span></a>
      <a href="#favorites" data-menu-type="${MenuType.FILTER}" class="main-navigation__item ${data[_models_movies__WEBPACK_IMPORTED_MODULE_1__["FilterName"].FAVORITES].isActive && activeItem === MenuType.FILTER ? `main-navigation__item--active` : ``}">${data.favorites.name[0].toUpperCase()}${data.favorites.name.slice(1)} <span class="main-navigation__item-count">${data.favorites.count}</span></a>
...
class MenuFilters extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
class ProfileRating extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/*!**************************************!*\
  !*** ./src/components/statistics.js ***!
  \**************************************/
/*! exports provided: StatsPeriod, PeriodIdMap, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StatsPeriod", function() { return StatsPeriod; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PeriodIdMap", function() { return PeriodIdMap; });
...
const StatsPeriod = {
  'statistic-all-time': _models_movies__WEBPACK_IMPORTED_MODULE_3__["Period"].ALL_TIME,
  'statistic-today': _models_movies__WEBPACK_IMPORTED_MODULE_3__["Period"].TODAY,
  'statistic-week': _models_movies__WEBPACK_IMPORTED_MODULE_3__["Period"].WEEK,
  'statistic-month': _models_movies__WEBPACK_IMPORTED_MODULE_3__["Period"].MONTH,
  'statistic-year': _models_movies__WEBPACK_IMPORTED_MODULE_3__["Period"].YEAR,
};

const PeriodIdMap = {
  [_models_movies__WEBPACK_IMPORTED_MODULE_3__["Period"].ALL_TIME]: `statistic-all-time`,
  [_models_movies__WEBPACK_IMPORTED_MODULE_3__["Period"].TODAY]: `statistic-today`,
  [_models_movies__WEBPACK_IMPORTED_MODULE_3__["Period"].WEEK]: `statistic-week`,
  [_models_movies__WEBPACK_IMPORTED_MODULE_3__["Period"].MONTH]: `statistic-month`,
  [_models_movies__WEBPACK_IMPORTED_MODULE_3__["Period"].YEAR]: `statistic-year`,
};
...
const renderGenresChart = (genresCtx, movies) => {
  return new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(genresCtx, {
...
class FilterController {
  constructor(container, movies) {
    ...
    this._filters = null;
    this._activeItem = _components_filters__WEBPACK_IMPORTED_MODULE_0__["MenuType"].FILTER;
  ...
  render() {
    ...
    this._filters = new _components_filters__WEBPACK_IMPORTED_MODULE_0__["default"](this._movies.getFilter(), this._activeItem);
    ...
    if (oldComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._filters, oldComponent);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._filters, _utils_render__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
    }
  }
...
/* harmony import */ var _models_movie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/movie */ "./src/models/movie.js");
/* harmony import */ var _components_film__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/film */ "./src/components/film.js");
...
class MovieController {
  ...
  render(movie) {
    ...
    this._filmComponent = new _components_film__WEBPACK_IMPORTED_MODULE_1__["default"](movie);

    this._filmComponent.setDetailClickHandler(() => this._viewChangeHandler(movie));

    this._filmComponent.setWatchlistClickHandler(Object(_utils_debounce__WEBPACK_IMPORTED_MODULE_3__["debounce"])(() => {
      const newMovie = _models_movie__WEBPACK_IMPORTED_MODULE_0__["default"].cloneMovie(movie);
      newMovie.isWatchlist = !newMovie.isWatchlist;

      this._dataChangeHandler(movie, newMovie);
    }));

    this._filmComponent.setAlreadyWatchedClickHandler(Object(_utils_debounce__WEBPACK_IMPORTED_MODULE_3__["debounce"])(() => {
      const newMovie = _models_movie__WEBPACK_IMPORTED_MODULE_0__["default"].cloneMovie(movie);
    ...
    this._filmComponent.setFavoriteClickHandler(Object(_utils_debounce__WEBPACK_IMPORTED_MODULE_3__["debounce"])(() => {
      const newMovie = _models_movie__WEBPACK_IMPORTED_MODULE_0__["default"].cloneMovie(movie);
    ...
    if (oldFilmComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._filmComponent, oldFilmComponent);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(this._container, this._filmComponent, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
    }
  }
}
...
/***/ "./src/controllers/movie-details-controller.js":
/*!*****************************************************!*\
  !*** ./src/controllers/movie-details-controller.js ***!
  \*****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MovieDetailsController; });
/* harmony import */ var _models_movie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/movie */ "./src/models/movie.js");
...
class MovieDetailsController {
  ...
  render(movie) {
    ...
    this._filmDetailsComponent = new _components_film_details__WEBPACK_IMPORTED_MODULE_1__["default"](movie, this._movieComments);

    this._filmDetailsComponent.setWatchlistClickHandler(Object(_utils_debounce__WEBPACK_IMPORTED_MODULE_3__["debounce"])(() => {
      const newMovie = _models_movie__WEBPACK_IMPORTED_MODULE_0__["default"].cloneMovie(movie);
      newMovie.isWatchlist = !newMovie.isWatchlist;
    ...
    this._filmDetailsComponent.setAlreadyWatchedClickHandler(Object(_utils_debounce__WEBPACK_IMPORTED_MODULE_3__["debounce"])(() => {
      const newMovie = _models_movie__WEBPACK_IMPORTED_MODULE_0__["default"].cloneMovie(movie);
      newMovie.isHistory = !newMovie.isHistory;
      newMovie.watchingDate = new Date();
    ...
    this._filmDetailsComponent.setFavoriteClickHandler(Object(_utils_debounce__WEBPACK_IMPORTED_MODULE_3__["debounce"])(() => {
      const newMovie = _models_movie__WEBPACK_IMPORTED_MODULE_0__["default"].cloneMovie(movie);
      newMovie.isFavorites = !newMovie.isFavorites;
    ...
    if (oldFilmDetailsComponent && this._isOpened) {
      ...
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._filmDetailsComponent, oldFilmDetailsComponent);
    }
  }
...
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
/* harmony import */ var _components_no_films__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/no-films */ "./src/components/no-films.js");
/* harmony import */ var _components_films_container__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/films-container */ "./src/components/films-container.js");
...
/* harmony import */ var _components_extra_films__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/extra-films */ "./src/components/extra-films.js");
...
/* harmony import */ var _movie_details_controller__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./movie-details-controller */ "./src/controllers/movie-details-controller.js");
...
class PageController {
  constructor(container, filmsModel, api) {
    ...
    this._filmsContainerComponent = new _components_films_container__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._filmsListComponent = new _components_films_list__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._showMoreButtonComponent = new _components_show_more_button__WEBPACK_IMPORTED_MODULE_4__["default"]();
    ...
    this._movieDetailsController = new _movie_details_controller__WEBPACK_IMPORTED_MODULE_8__["default"](this._dataChangeHandler, this._api);
  ...
  renderFilms() {
    ...
    this._displayedFilms.slice(0, this._showingFilmsCount).forEach((film) => {
      const filmController = new _movie_controller__WEBPACK_IMPORTED_MODULE_7__["default"](this._filmsListContainer, this._dataChangeHandler, this._viewChangeHandler);
  ...
  renderExtraFilms() {
    ...
    if (this._mostCommentedFilms.length > 0) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._filmsListExtraContainer, new _components_extra_films__WEBPACK_IMPORTED_MODULE_5__["default"](`Most commented`), _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
    }

    if (this._topRatedFilms.length > 0) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._filmsListExtraContainer, new _components_extra_films__WEBPACK_IMPORTED_MODULE_5__["default"](`Top rated movies`), _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
    }

    const renderExtra = (filmsListContainer, movies) => {
      movies.forEach((movie) => {
        const filmController = new _movie_controller__WEBPACK_IMPORTED_MODULE_7__["default"](filmsListContainer, this._dataChangeHandler, this._viewChangeHandler);
  ...
  render() {
    ...
    if (this._noFilmsComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._noFilmsComponent);
    }

    if (!films.length) {
      this._noFilmsComponent = new _components_no_films__WEBPACK_IMPORTED_MODULE_1__["default"](this._isLoading);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._noFilmsComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
      return;
    }

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._sortComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);

    const filmsContainer = this._filmsContainerComponent;
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(container, filmsContainer, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);

    const filmsList = this._filmsListComponent;
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(filmsContainer.getElement(), filmsList, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
  ...
  _renderShowMoreButton() {
    if (this._displayedFilms.length > SHOWING_FILMS_ON_START) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._filmsListContainer, this._showMoreButtonComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTER);
    } else {
...
/* harmony import */ var _components_statistics__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/statistics */ "./src/components/statistics.js");
/* harmony import */ var _models_movies__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/movies */ "./src/models/movies.js");
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
/* harmony import */ var _models_profile__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/profile */ "./src/models/profile.js");
...
class StatisticsController {
  constructor(container, moviesModel) {
    ...
    this._period = _models_movies__WEBPACK_IMPORTED_MODULE_1__["Period"].ALL_TIME;
  ...
  render() {
    ...
    this._statistics = new _components_statistics__WEBPACK_IMPORTED_MODULE_0__["default"](this._moviesModel.getUserMoviesStats(this._period), Object(_models_profile__WEBPACK_IMPORTED_MODULE_3__["getProfileRank"])(watchedMoviesQuantity));
    ...
    if (oldComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._statistics, oldComponent);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(this._container, this._statistics, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
    }
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return UserProfileController; });
/* harmony import */ var _components_profile_rating__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/profile-rating */ "./src/components/profile-rating.js");
/* harmony import */ var _models_profile__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/profile */ "./src/models/profile.js");
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
...
class UserProfileController {
  ...
  render() {
    ...
    const watchedMoviesQuantity = this._moviesModel.getMoviesNumber(this._moviesModel.getMovies().filter((movie) => movie.isHistory));
    this._profileComponent = new _components_profile_rating__WEBPACK_IMPORTED_MODULE_0__["default"](Object(_models_profile__WEBPACK_IMPORTED_MODULE_1__["getProfileRank"])(watchedMoviesQuantity));

    if (oldComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._profileComponent, oldComponent);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(this._container, this._profileComponent, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
    }
  }
}
...
/* harmony import */ var _controllers_filter_controller__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./controllers/filter-controller */ "./src/controllers/filter-controller.js");
/* harmony import */ var _components_filters__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/filters */ "./src/components/filters.js");
/* harmony import */ var _controllers_statistics_controller__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./controllers/statistics-controller */ "./src/controllers/statistics-controller.js");
/* harmony import */ var _controllers_user_profile_controller__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./controllers/user-profile-controller */ "./src/controllers/user-profile-controller.js");
...
const api = new _api__WEBPACK_IMPORTED_MODULE_0__["default"](URL, AUTHORIZATION);
...
const filtersController = new _controllers_filter_controller__WEBPACK_IMPORTED_MODULE_5__["default"](siteMainElement, moviesModel);
const filmsComponent = new _components_films_container__WEBPACK_IMPORTED_MODULE_2__["default"]();
const pageController = new _controllers_page_controller__WEBPACK_IMPORTED_MODULE_1__["default"](filmsComponent, moviesModel, apiWithProvider);

filtersController.render();
Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["render"])(siteMainElement, filmsComponent, _utils_render__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
...
apiWithProvider.getMovies()
  .then((movies) => {
    ...
    const statisticsController = new _controllers_statistics_controller__WEBPACK_IMPORTED_MODULE_7__["default"](siteMainElement, moviesModel);
    const userProfileController = new _controllers_user_profile_controller__WEBPACK_IMPORTED_MODULE_8__["default"](siteHeaderElement, moviesModel);
    ...
    filtersController.setChangeMenuHandler((menuType) => {
      switch (menuType) {
        case _components_filters__WEBPACK_IMPORTED_MODULE_6__["MenuType"].FILTER:
          statisticsController.hide();
          filmsComponent.show();
          break;
        case _components_filters__WEBPACK_IMPORTED_MODULE_6__["MenuType"].STATS:
...
/*!******************************!*\
  !*** ./src/models/movies.js ***!
  \******************************/
/*! exports provided: FilterName, Period, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const Period = {
  ALL_TIME: moment__WEBPACK_IMPORTED_MODULE_1___default()(new Date(0)),
  TODAY: moment__WEBPACK_IMPORTED_MODULE_1___default()().subtract(1, `days`),
  WEEK: moment__WEBPACK_IMPORTED_MODULE_1___default()().subtract(1, `weeks`),
  MONTH: moment__WEBPACK_IMPORTED_MODULE_1___default()().subtract(1, `months`),
  YEAR: moment__WEBPACK_IMPORTED_MODULE_1___default()().subtract(1, `years`),
};
...
class Movies {
  constructor() {
    ...
    this._activeSortType = _components_sort__WEBPACK_IMPORTED_MODULE_0__["SortType"].DEFAULT;
  ...
  getMovies() {
    ...
    switch (this._activeSortType) {
      case _components_sort__WEBPACK_IMPORTED_MODULE_0__["SortType"].RATING:
        movies = [...movies].sort((a, b) => b.totalRating - a.totalRating);
        break;
      case _components_sort__WEBPACK_IMPORTED_MODULE_0__["SortType"].DATE:
  ...
  getUserMoviesStats(period) {
    const moviesFromPeriod = this._movies
      .filter((movie) => movie.isHistory && moment__WEBPACK_IMPORTED_MODULE_1___default()(movie.watchingDate) >= period);
...
/*!*******************************!*\
  !*** ./src/models/profile.js ***!
  \*******************************/
/*! exports provided: getProfileRank */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const getProfileRank = (watchedFilmsNumber) => {
  switch (true) {
...
/*!****************************!*\
  !*** ./src/utils/utils.js ***!
  \****************************/
/*! exports provided: commentEmotions, formatTime, formatYear, formatDate, formatCommentDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "commentEmotions", function() { return commentEmotions; });
...
const commentEmotions = new Set([`smile`, `sleeping`, `puke`, `angry`]);

const formatTime = (time) => {
  const duration = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(time, `minutes`);

  return moment__WEBPACK_IMPORTED_MODULE_0___default.a.utc(duration.asMilliseconds()).format(`h[h] mm[m]`);
};
...
const formatCommentDate = (date) => {
  let result = moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`YYYY/MM/DD HH:MM`);

  switch (true) {
    case moment__WEBPACK_IMPORTED_MODULE_0___default()(date).isBetween(moment__WEBPACK_IMPORTED_MODULE_0___default()().subtract(59, `seconds`), moment__WEBPACK_IMPORTED_MODULE_0___default()()):
      result = `now`;
      break;
    case moment__WEBPACK_IMPORTED_MODULE_0___default()(date).isBetween(moment__WEBPACK_IMPORTED_MODULE_0___default()().subtract(3, `minutes`), moment__WEBPACK_IMPORTED_MODULE_0___default()()):
      result = `a minute ago`;
      break;
    case moment__WEBPACK_IMPORTED_MODULE_0___default()(date).isBetween(moment__WEBPACK_IMPORTED_MODULE_0___default()().subtract(59, `minutes`), moment__WEBPACK_IMPORTED_MODULE_0___default()()):
      result = `a few minutes ago`;
      break;
    case moment__WEBPACK_IMPORTED_MODULE_0___default()(date).isBetween(moment__WEBPACK_IMPORTED_MODULE_0___default()().subtract(2, `hours`), moment__WEBPACK_IMPORTED_MODULE_0___default()()):
      result = `an hour ago`;
      break;
    case moment__WEBPACK_IMPORTED_MODULE_0___default()(date).isBetween(moment__WEBPACK_IMPORTED_MODULE_0___default()().subtract(24, `hours`), moment__WEBPACK_IMPORTED_MODULE_0___default()()):
      result = `a few hours ago`;
      break;
    case moment__WEBPACK_IMPORTED_MODULE_0___default()(date).isBetween(moment__WEBPACK_IMPORTED_MODULE_0___default()().subtract(1, `days`), moment__WEBPACK_IMPORTED_MODULE_0___default()()):
      result = `a day ago`;
      break;
    case moment__WEBPACK_IMPORTED_MODULE_0___default()(date).isBetween(moment__WEBPACK_IMPORTED_MODULE_0___default()().subtract(2, `days`), moment__WEBPACK_IMPORTED_MODULE_0___default()()):
      result = `two days ago`;
      break;
    case moment__WEBPACK_IMPORTED_MODULE_0___default()(date).isBetween(moment__WEBPACK_IMPORTED_MODULE_0___default()().subtract(3, `days`), moment__WEBPACK_IMPORTED_MODULE_0___default()()):
